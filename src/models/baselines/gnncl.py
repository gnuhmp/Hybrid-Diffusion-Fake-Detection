...
class GNNCLNet(torch.nn.Module): # Đổi tên Net -> GNNCLNet
    # Cập nhật init
    def __init__(self, in_channels, nhid, num_classes=2, max_nodes=500):
        super(GNNCLNet, self).__init__()
    ...
    def forward(self, data):
        # Biến Sparse thành Dense âm thầm ở đây
        ...
        x_emb = F.relu(self.lin1(x_emb))
        x_out = self.lin2(x_emb)
